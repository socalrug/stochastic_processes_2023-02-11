volcanoes.data <- read.csv(file=file.path("examples", "Poisson_Process", "data", "volcanoesdata.csv"),
                           header=TRUE, sep=",")
...
plot(time,N, type="n", main="Volcano Eruption Process", xlab="Time", ylab="State",
     panel.first = grid())
