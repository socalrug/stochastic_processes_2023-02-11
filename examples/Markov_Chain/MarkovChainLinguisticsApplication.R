...
#####################################################
library(tidyverse)
text <- read_file(file.path("examples", "Markov_Chain", "data", "Onegin.txt"))
...
consonants <- c("б","в","г","д","ж","з","к","л","м","н","п","р","с","т","ф","х","ц","ч","ш","щ","ѳ")
...
#####################################################
library(tidyverse)
text  <- read_file(file.path("examples", "Markov_Chain", "data", "ATaleOfTwoCities.txt"))
...
############################################################
library(tidyverse)
text  <- read_file(file.path("examples", "Markov_Chain", "data", "CienAnosDeSoledad.txt"))
...
#########################################################
library(tidyverse)
text  <- read_file(file.path("examples", "Markov_Chain", "data", "LePetitPrince.txt"))
...
#####################################################
library(tidyverse)
text  <- read_file(file.path("examples", "Markov_Chain", "data", "MobyDick.txt"))
...
#########################################################
library(tidyverse)
text <- read_file(file.path("examples", "Markov_Chain", "data", "CrimeAndPunishment.txt"))
...
################################################
library(tidyverse)
text  <- read_file(file.path("examples", "Markov_Chain", "data", "DonQuijote.txt"))
...
############################################
library(tidyverse)
text  <- read_file(file.path("examples", "Markov_Chain", "data", "LesMiserables.txt"))
